...
def main():
    ...
    contact_id = "YOUR_CONTACT_ID"    # <-- Replace with actual contactId (e.g., "101")

    # Your API path (same as C#): /api/v1/Contacts/{contactId}
    # Note: keep "Contacts" exactly as in your C# sample (some servers may be case-sensitive).
    api_path = f"/api/v1/Contacts/{contact_id}"
