...
def main():
    ...
    contact_group_id = "YOUR_CONTACT_GROUP_ID"  # <-- Replace with actual contactGroupId (e.g., "123")

    # Your API path (same as C#): /api/v1/contact_groups/{contactGroupId}
    api_path = f"/api/v1/contact_groups/{contact_group_id}"
