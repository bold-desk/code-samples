...
class Command(BaseCommand):
    help = 'Get a contact by ID from BoldDesk API.'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--id', dest='contact_id', required=True, help='Contact ID')
    ...
    def handle(self, *args, **options):
        ...
        url = f'https://{domain}/api/v1/contacts/{contact_id}'
